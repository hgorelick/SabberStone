...
namespace SabberStoneCoreConsole
{
	internal class Program
	{
		...
		private static void SimpleTest()
		{
			...
			SabberStoneCore.Model.Zones.HandZone hand = clone.CurrentOpponent.HandZone;
			SabberStoneCore.Model.Zones.DeckZone deck = clone.CurrentOpponent.DeckZone;
			int n = hand.Count;
			for (int i = n; i > 0;)
			{
				IPlayable card = hand[--i];
		...
		static void ChameleosPintSizedSummonerDouble()
		{
			...
			int chameleosId = game.Player1.HandZone[0].Id;
