...
namespace SabberStoneCore.Config
{
	...
	public class GameConfig
	{
		...
		/// Gets or sets the deck of the player with index 1.</summary>
		/// <value><see cref="Deck"/></value>
		public Model.Deck Player1ModelDeck { get; set; } // = null;

		/// <summary>
		/// Gets or sets the deck of the player with index 2.</summary>
		/// <value><see cref="Deck"/></value>
		/// <autogeneratedoc />
		public Model.Deck Player2ModelDeck { get; set; } // = null;

		public int Player1Health { get; set; } = 30;
		public int Player2Health { get; set; } = 30;
	...
	public sealed class GameConfigBuilder
	{
		...
		private Model.Deck player1ModelDeck = null;
		private Model.Deck player2ModelDeck = null;
		...
		public GameConfigBuilder SetPlayer1(string playerName, Card playerHeroCard, CardClass playerHeroClass, Deck deck, FormatType formatType)
		{
			player1Name = playerName;
		...
		public GameConfigBuilder SetPlayer2(string playerName, Card playerHeroCard, CardClass playerHeroClass, Deck deck, FormatType formatType)
		{
			player2Name = playerName;
